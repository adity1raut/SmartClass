...
import {
  // Pass-through (no DB)
  chat, summarize, explain, agent,
  generateQuiz, feedback, studyPlan, courseOutline, analyzePerformance,
  generateAssignment, generateClassAgenda,
  // Quiz → DB
  saveQuizToCourse,
  // Submission feedback → DB
  feedbackAndSave,
  // Performance with real data
  getPerformanceContext, analyzeRealPerformance,
  // Study plans CRUD
  generateAndSaveStudyPlan, saveStudyPlan, getStudyPlans, deleteStudyPlan,
  // Outlines CRUD
  generateAndSaveOutline, saveOutline, getOutlines, deleteOutline,
