      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8 relative z-10">
        <div className="w-full max-w-5xl grid lg:grid-cols-[1.05fr_0.95fr] gap-10 items-center animate-in fade-in duration-500">
          ...
          >
            ...
            {/* Role selector */}
            <div
              className="grid grid-cols-2 gap-2.5 mb-6 animate-in fade-in slide-in-from-top-4 duration-500"
            ...
            <p
              className="text-center text-xs text-[var(--muted)] mt-4 animate-in fade-in duration-500"
