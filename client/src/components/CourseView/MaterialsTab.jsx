    ...
    <div>
      ...
      {!isTeacher && materials.length > 0 && (
        <div className="flex items-center gap-3 mb-5 px-4 py-3 glass rounded-2xl border border-[var(--border)]/15">
          <div className="w-8 h-8 rounded-xl bg-emerald-500/15 border border-emerald-500/20 flex items-center justify-center text-sm">
            📊
          </div>
          <div className="flex-1">
            ...
            <div className="mt-1 h-1.5 bg-[var(--border)]/20 rounded-full overflow-hidden">
              <div
                ...
                style={{
                  width: `${materials.length ? Math.round((doneCount / materials.length) * 100) : 0}%`,
                }}
              />
            </div>
          </div>
