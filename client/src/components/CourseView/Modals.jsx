...
const textareaCls =
  "w-full px-4 py-3 border border-[var(--border)]/50 rounded-xl text-sm outline-none resize-y focus:border-[var(--accent)] focus:ring-4 focus:ring-[var(--accent)]/10 focus:shadow-[0_4px_16px_-4px_var(--accent)] transition-all duration-300 glass text-[var(--text)] placeholder:text-[var(--muted)]/50 hover:border-[var(--accent)]/30";
...
export const modalOverlay = (onClose, children) => (
  ...
  >
    <div
      className="glass-heavy border border-[var(--border)]/50 rounded-2xl p-8 w-full max-w-lg max-h-[90vh] overflow-y-auto 
