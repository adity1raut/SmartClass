    ...
    <div className="sc-card-premium glass p-1 overflow-hidden">
      <div className="px-5 py-4 border-b border-[var(--border)]/30">
        <p className="text-sm font-bold text-[var(--text)] flex items-center gap-2">
          <span className="w-6 h-6 rounded-lg bg-[var(--accent)]/15 flex items-center justify-center text-xs">
            💡
          </span>
          Why SmartClass?
        </p>
      ...
      {FEATURES.map((f, i) => (
        ...
        >
          <span
            className="w-8 h-8 rounded-lg bg-[var(--accent)]/10 flex items-center justify-center text-sm
