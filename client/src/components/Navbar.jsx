    ...
    active
      ...
      : "text-[var(--muted)] hover:bg-green-500/10 hover:text-green-500"
              ...
              {link.dropdown && isOpen && (
                <div className="absolute top-full mt-2 w-52 rounded-2xl
    ...
    {isAuthenticated ? (
      <>
        ...
        <div className="relative" ref={ref}>
          ...
          {open && (
            <div className="absolute right-0 top-12 w-80 rounded-2xl bg-[var(--surface)] border border-[var(--border)]
              shadow-xl overflow-hidden animate-[scale-in_0.2s_ease]">
              ...
              <div className="max-h-64 overflow-y-auto">
                {notifs.length === 0 ? (
                  ...
                  notifs.map((n) => (
                    ...
                    >
                      <p className="text-[var(--text)] leading-relaxed">{n.message}</p>
        ...
        {/* USER */}
        <div className="hidden lg:flex items-center gap-3 px-4 py-2 rounded-2xl border border-[var(--border)]
...
>
  ...
  {/* Avatar */}
  <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[var(--accent)] to-green-600
    ...
    {user.name?.charAt(0)}
        ...
        {mobileMenuOpen && (
          <div className="absolute right-4 top-16 w-64 rounded-2xl bg-[var(--surface)] border border-[var(--border)]
